    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<JwtBearerOptions>(JwtBearerDefaults.AuthenticationScheme, options =>
            {
                ...
                {
                    List<string> auds = (List<string>)audiences;
                    if (auds.Contains(Configuration["ApiAudience"]))
                        return true;
                    return false;
                };
            });
            ...
            //{
            //    options.AddPolicy("ApiCall", policy => policy.Requirements.Add(new RoleRequirement("Api.Call")));
            //});
